      ...
      rollupOptions: {
        output: {
          ...
          assetFileNames: (assetInfo) => {
            ...
            if (
              ["png", "jpg", "jpeg", "gif", "svg", "webp", "avif", "ico"].includes(String(extension))
            ) {
              return "assets/img/[name]-[hash][extname]";
            }

            if (["woff", "woff2", "ttf", "otf", "eot"].includes(String(extension))) {
